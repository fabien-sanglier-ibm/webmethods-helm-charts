...
```bash
helm repo add webmethods https://ibm.github.io/webmethods-helm-charts/
helm repo update
```
...
```bash
helm install <release-name> terracotta/helm/. [flags]
```

Example:

```bash
helm install my-terracotta terracotta/helm/.
```
...
```bash
helm install my-terracotta terracotta/helm/ -f values.yaml
```
...
```bash
helm upgrade my-terracotta terracotta/helm/ [flags]
```
...
```bash
helm install <release-name> terracotta/helm/
For ex:-
helm install "my-release" --set fullnameOverride="myrelease" terracotta/helm/.
```
...
myrelease-tms-0                                             1/1     Running   0          35s
myrelease-operator-66b7fddc97-7mskc                         1/1     Running   0          35s
myrelease-terracotta-stripe-1-1                             1/1     Running   0          33s
myrelease-terracotta-stripe-1-1                             1/1     Running   0          33s
myrelease-terracotta-stripe-2-0                             1/1     Running   0          33s
myrelease-terracotta-stripe-2-1                             1/1     Running   0          33s

kubectl get pvc
NAME                                       STATUS   VOLUME                                     CAPACITY   ACCESS MODES   STORAGECLASS   AGE
tmsdata-myrelease-tms-0                     Bound    pvc-005091fc-dee0-4d42-be4e-6be0e07d8c0f   5Gi        RWO            local-path     83s
corestore-myrelease-terracotta-stripe-2-0   Bound    pvc-3a109ca7-1c10-481f-9a6a-573f894de38f   10Gi       RWO            local-path     81s
corestore-myrelease-terracotta-stripe-1-0   Bound    pvc-f0c34001-593b-466c-bea5-b9c228d7b8d0   10Gi       RWO            local-path     81s
corestore-myrelease-terracotta-stripe-1-1   Bound    pvc-7b3e40e1-78ff-4bf5-88fa-9679ab2e85cf   10Gi       RWO            local-path     81s
corestore-myrelease-terracotta-stripe-2-1   Bound    pvc-422d1959-d970-4418-b1d0-1b09198fde95   10Gi       RWO            local-path     81s

kubectl get deployments
NAME                             READY   UP-TO-DATE   AVAILABLE   AGE
my-release-operator              1/1     1            1           3m24s

kubectl get statefulsets
NAME                            READY      AGE
myrelease-tms                   1/1        14m
myrelease-terracotta-stripe-1   2/2        14m
myrelease-terracotta-stripe-2   2/2        14m

kubectl get svc
NAME                                    TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)             AGE
kubernetes                              ClusterIP   10.43.0.1    <none>        443/TCP             20d
myrelease-tms-service                   ClusterIP   None         <none>        9480/TCP            14m
myrelease-terracotta-stripe-1-service   ClusterIP   None         <none>        9410/TCP,9430/TCP   14m
myrelease-terracotta-stripe-2-service   ClusterIP   None         <none>        9410/TCP,9430/TCP   14m
...
```
helm upgrade "my-release" --set fullnameOverride="myrelease" terracotta/helm/.

kubectl get pods
NAME                                                        READY   STATUS    RESTARTS   AGE
myrelease-operator-66b7fddc97-7mskc                         1/1     Running   0          48m
myrelease-terracotta-stripe-2-0                             1/1     Running   0          48m
myrelease-terracotta-stripe-1-0                             1/1     Running   0          48m
myrelease-terracotta-stripe-1-1                             1/1     Running   0          48m
myrelease-terracotta-stripe-2-1                             1/1     Running   0          48m
myrelease-tms-0                                             1/1     Running   0          80s
myrelease-terracotta-stripe-1-2                             1/1     Running   0          78s
myrelease-terracotta-stripe-2-2                             1/1     Running   0          29s

the pvcs for the newly created pod -
corestore-myrelease-terracotta-stripe-1-2   Bound    pvc-4fd7a59c-3772-4f00-bf8f-cb25fcf2e8b6   10Gi       RWO            local-path     95s
corestore-myrelease-terracotta-stripe-2-2   Bound    pvc-2064205a-1b38-4d47-ac3f-3bf04171e900   10Gi       RWO            local-path     46s
```
...
kubectl get pods
NAME                                                       READY   STATUS    RESTARTS   AGE
myrelease-operator-66b7fddc97-7mskc                         1/1     Running   0          54m
myrelease-terracotta-stripe-2-0                             1/1     Running   0          54m
myrelease-terracotta-stripe-1-0                             1/1     Running   0          54m
myrelease-terracotta-stripe-1-1                             1/1     Running   0          54m
myrelease-terracotta-stripe-2-1                             1/1     Running   0          54m
myrelease-tms-0                                             1/1     Running   0          113s

You can verify the pvcs also get deleted.
 kubectl get pvc
NAME                                        STATUS   VOLUME                                     CAPACITY   ACCESS MODES   STORAGECLASS   AGE
tmsdata-myrelease-tms-0                     Bound    pvc-005091fc-dee0-4d42-be4e-6be0e07d8c0f   5Gi        RWO            local-path     108m
corestore-myrelease-terracotta-stripe-2-0   Bound    pvc-3a109ca7-1c10-481f-9a6a-573f894de38f   10Gi       RWO            local-path     108m
corestore-myrelease-terracotta-stripe-1-0   Bound    pvc-f0c34001-593b-466c-bea5-b9c228d7b8d0   10Gi       RWO            local-path     108m
corestore-myrelease-terracotta-stripe-1-1   Bound    pvc-7b3e40e1-78ff-4bf5-88fa-9679ab2e85cf   10Gi       RWO            local-path     108m
corestore-myrelease-terracotta-stripe-2-1   Bound    pvc-422d1959-d970-4418-b1d0-1b09198fde95   10Gi       RWO            local-path     108m
```
...
kubectl get pods
NAME                                                        READY   STATUS    RESTARTS   AGE
myrelease-terracotta-stripe-1-0                             1/1     Running   0          154m
myrelease-terracotta-stripe-1-1                             1/1     Running   0          154m
myrelease-terracotta-stripe-2-0                             1/1     Running   0          154m
myrelease-terracotta-stripe-2-1                             1/1     Running   0          154m
myrelease-operator-66b7fddc97-7mskc                         1/1     Running   0          154m
myrelease-tms-0                                             1/1     Running   0          2m18s
myrelease-terracotta-stripe-3-0                             1/1     Running   0          2m18s
myrelease-terracotta-stripe-3-1                             1/1     Running   0          2m18s

kubectl get statefulsets
NAME                            READY   AGE
myrelease-terracotta-stripe-1   2/2     155m
myrelease-terracotta-stripe-2   2/2     155m
myrelease-tms                   1/1     155m
myrelease-terracotta-stripe-3   2/2     2m46s

kubectl get svc
NAME                                    TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)             AGE
kubernetes                              ClusterIP   10.43.0.1    <none>        443/TCP             20d
myrelease-tms-service                   ClusterIP   None         <none>        9480/TCP            155m
myrelease-terracotta-stripe-1-service   ClusterIP   None         <none>        9410/TCP,9430/TCP   155m
myrelease-terracotta-stripe-2-service   ClusterIP   None         <none>        9410/TCP,9430/TCP   155m
myrelease-terracotta-stripe-3-service   ClusterIP   None         <none>        9410/TCP,9430/TCP   3m2s
```
...
kubectl get deployments
NAME                                       READY   UP-TO-DATE   AVAILABLE   AGE
myrelease-operator                         1/1     1            1           84s
myrelease-terracotta-voter                 1/1     1            1           21s
```
